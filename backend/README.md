...
## Project Structure
    ...
    ├── ideapros_llc_stream_33286  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_stream_33286`
...
2. Clone this repo and `cd ideapros_llc_stream_33286`
